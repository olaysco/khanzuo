...
ipcMain.handle('agent:startSession', (_event, payload) => goBridge.request('start-session', payload));
ipcMain.handle('agent:stopSession', (_event, payload) => goBridge.request('stop-session', payload));
